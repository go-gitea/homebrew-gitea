...
class Gitea < Formula
  ...
  stable do
    url "https://dl.gitea.io/gitea/1.1.4/gitea-1.1.4-darwin-10.6-amd64"
    sha256 `curl -s https://dl.gitea.io/gitea/1.1.4/gitea-1.1.4-darwin-10.6-amd64.sha256`.split(" ").first
    version "1.1.4"
  end
